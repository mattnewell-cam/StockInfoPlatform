...
from companies.views import signup, verify_email, home, search_api, logout_view, robots_txt, sitemap_xml
...
urlpatterns = [
    ...
    path('notes/<str:slug>/', company_views.notes_company, name='notes_company'),
